...
subject: "Assistant Professor Search, Escuela de Gobierno"
format:
  letter-typst: default
---

```{r setup, include=F}
jobtitle = "call for Assistant Professors"
research = "the challenges to accountability, representation, and governance in the Global South from an evidence-informed policy perspective"
place = "the PUC"
discipline = "political science"
subfield = "evidence-informed public policy and quantitative methods"
courses = "research design, data analysis, evidence-informed policy, democracy and its challenges, and crime and public safety"
source = "website"
```
...
Before joining Northwestern, I taught Data Analysis for Public Policy and Public Opinion, Introduction to Comparative Politics and, and Politics of Developing Democracies. Beyond the classroom, I collaborate with a rising sophomore, as part of the Farrell Fellowship program at Northwestern, on various projects in my agenda. I also advise theses in Political Science and the program in Mathematical Methods for the Social Sciences.
...
<!-- CLOSING -->
I believe my expertise makes me an excellent fit at `r place`. Furthermore, it would be an honor to contribute to my alma mater's excellence mission. If you have any questions, you can contact me via email or phone.
