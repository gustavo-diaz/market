...
subject: "Lecturer Position, Public Policy"
format:
  letter-typst: default
---

```{r setup, include=F}
jobtitle = "call for a Lecturer in Public Policy"
...
subfield = "comparative public policy and quantitative methods"
courses = "comparative public policy, challenges to democracy, politics of the Global South/Latin America, as well as core and electives on research methods"
source = "website"
```
