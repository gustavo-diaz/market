...
subject: "Assistant Professor Position, Department of Political Science"
format:
  letter-typst: default
---

```{r setup, include=F}
jobtitle = "call for an Assistant Professor in Comparative Politics or International Relations"
research = "the barriers to democracy in the Global South"
place = "Penn State"
discipline = "political science"
subfield = "comparative politics and quantitative methods"
courses = "research design and quantitative methods along the required sequence at all levels. I am also eager to develop new courses on causal inference, experiments, computational social science, comparative politics, challenges to democracy, and politics of the Global South/Latin America"
source = "website"
```
...
Before joining Northwestern, I taught Data Analysis for Public Policy and Public Opinion, Introduction to Comparative Politics and, and Politics of Developing Democracies. Beyond the classroom, I am currently mentoring a rising sophomore as part of the Farrell Fellowship program at Northwestern, with the objective of incorporating them as a co-author on projects on experimental research design.
