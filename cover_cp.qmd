...
subject: "Assistant Professor Position, International Politics"
format:
  letter-typst: default
---

```{r setup, include=F}
jobtitle = "call for an Assistant Professor in International Politics"
research = "the challenges to accountability, representation, and governance in the in the Global South"
place = "Western"
discipline = "political science"
subfield = "comparative politics and quantitative methods"
courses = "comparative politics, challenges to democracy, politics of the Global South/Latin America, as well as core and electives on quantitative methods"
source = "website"
```
