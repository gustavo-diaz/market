...
This program also serves as a platform for innovation in research design and survey methods. For example, in a piece currently under review in *Political Analysis*, we use our pilot data to introduce methods to recover valid estimates when placebo-controlled list experiments produce implausible results, which helps in crafting question format and justifying questionnaire design. 
