...
2026: University of Chicago \
`#h(1cm)`{=typst} Midwest Political Science Association. Chicago, IL \
`#h(1cm)`{=typst} Annual Meeting of the Society for Political Methodology. Michigan State University \
`#h(1cm)`{=typst} American Political Science Association. Boston, MA
