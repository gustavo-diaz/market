...
At Tulane, I taught an undergrad senior course on the challenges to democracy from the perspective of evidence-based policy making. This course the proposed solutions to these challenges, and how governments, researchers, and civil society organizations use data to evaluate these solutions. The previous version focused primarily design-based causal inference, but future versions will also feature data science and machine learning.
