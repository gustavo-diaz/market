...
methods_offer = "courses on probability and statistics, design-based causal inference, machine learning, data visualization, and statistical computing"
source = "website"
```
...
At Northwestern, I am the central person statistics courses in the department. I teach the first course in the graduate methods sequence, focusing on probability and statistical inference. I also teach the undergrad level introduction to research methods in political science, a course that teaches political science majors to become informed consumers of data analysis. I am the primary instructor (along with graduate TAs) for the math camp program for incoming political science and sociology students, and run the year-long statistical computing workshop that introduces cutting-edge coding practices. This quarter, I will teach a seminar on the use of design-based causal inference and machine learning methods to inform decision-making in academia, policy, and industry. Next year, I will add an advanced graduate seminar on machine learning to my portfolio.
