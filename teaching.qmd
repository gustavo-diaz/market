...
methods_offer = "research design and data analysis throughout the required sequence. I can also offer electives on survey research, data visualization, statistical computing, and data for decision-making"
source = "website"
```
