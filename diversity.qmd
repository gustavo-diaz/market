...
```{r, include = FALSE}
field = "applied statistics and social science research"
person = "statistician"
```
...
At Northwestern, I facilitate collaborative lab-style spaces for open-ended group work. As part of both my introductory graduate methods course and the coding workshop I organize, participants can bring their own methods-related work to the lab session and benefit from group learning in a low-stakes setting.
