...
My initial efforts focused on facilitating out-of-classroom learning opportunities, which I consider essential to break initial entry barriers. At Illinois, I started a methods cheatsheets project in 2018. In this project, volunteer graduate students write short introductions to the theory, implementation, and current debates surrounding a technique of their expertise.

At Northwestern, I facilitate collaborative spaces for open-ended group work. My office is purposefully set up next to a meeting room equipped for collective data work.  As part of my graduate methods courses, students can bring their own methods-related work to the lab session and benefit from group learning in a low-stakes setting. This space is also open to the broader Northwestern community.
