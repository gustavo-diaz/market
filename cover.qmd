...
courses = "in the required research design and data analysis sequence across levels, electives on survey research, experiments, causal inference, and machine learning, and summer school modules on sensitive questions in surveys or the design of survey experiments"
source = "website"
```
...
My teaching focuses on making quantitative methods accessible to diverse audiences. I accomplish this through a combination of flexibility and accountability. At Northwestern, I am the central person teaching methods courses in the department. I teach the first course in the PhD sequence (equivalent to *Análisis Cuantitativo I*), the required undergrad-level Introduction to Empirical Methods (equivalent to *Epistemología y Diseño de Investigación en Ciencia Política*), and an undergraduate research seminar (equivalent to an *Optativo de Profundización*) on how data and experimentation are used in government, industry, and civil society to inform decision-making. Before Joining Northwestern, I taught Data Analysis for Public Opinion and Policy at McMaster.
...
Beyond the classroom, I serve as an undergraduate advisor, lead the Math Camp program for incoming political science and sociology PhD students, and run the Statistical Computing Workshop that brings internal and external speakers to introduce cutting-edge developments in computational social science. 

<!-- I collaborate with two undergraduate coauthors as part of the Farrell fellowship mentoring program on experimental design, and I also advise senior theses in Political Science and the program in Mathematical Methods for the Social Sciences. -->
...
<!-- CLOSING -->
I believe my expertise makes me an excellent fit at `r place`. Moreover, I would cherish the opportunity to return to my alma mater in this role. If you have any questions, you can contact me via email or phone.
