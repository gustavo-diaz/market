...
subject: "Lecturer/Assistant Professor Search, School of Politics and International Relations"
format:
  letter-typst: default
---

```{r setup, include=F}
jobtitle = "call for a Lecturer/Assistant Professor"
research = "on quantitative methods for the social sciences"
place = "UCD"
discipline = "policy"
subfield = "comparative politics and political behavior"
courses = "research design, quantitative methods, experiments, survey research, machine learning, and computational social science"
source = "website"
```
