...
subject: "Assistant Professor Search, Quantitative Political Methodology"
format:
  letter-typst: default
---

```{r setup, include=F}
jobtitle = "call for an Assistant Professor in Quantitative Political Methodology"
research = "improving experimental design in the social sciences"
place = "UNC"
discipline = "political science"
subfield = "comparative politics and political behavior"
courses = "on statistics, research design, experiments, machine learning, and computational social science"
source = "website"
```
...
Focusing on survey and field experiments, this agenda seeks to shape applied research by focusing on cases where one can seemingly improve statistical precision without sacrificing unbiasedness. As I show in my work, this usually implies unforeseen costs in other dimensions.
...
<!-- CLOSING -->
I believe my expertise makes me an excellent fit at `r place`. Moreover, this position presents an opportunity to relocate closer to family, which makes it even more attractive. If you have any questions, you can contact me via email or phone.
