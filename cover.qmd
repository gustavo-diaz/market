...
subject: "Assistant Professor Search, Computational Social Science"
format:
  letter-typst: default
---

```{r setup, include=F}
jobtitle = "call for an Assistant Professor in Computational Social Science. I had previously applied to your open rank search in the same area and was invited to apply to this new position"
research = "improving research design"
place = "URI"
