...
subject: "Teaching Stream Assistant Professor, Data Science"
format:
  letter-typst: default
---

```{r setup, include=F}
jobtitle = "call for a Teaching Stream Assistant Professor in Data Science"
...
courses = "on statistics, data science, machine learning, design-based causal inference, data visualization, and applications in computational social science"
source = "website"
```
...
<!-- Before joining Northwestern, I taught Data Analysis for Public Policy and Public Opinion, and Politics of Developing Democracies from an evidence-informed policy perspective. Both courses emphasized using statistics and data science to generate credible evidence. -->
