...
applications = "to questions of evidence-informed policy-making, especially around the challenges to accountability, governance, and representation"
region = "Global South"
```
...
I apply the insights of my methodological work `r applications`. The common theme across these applications is the goal of improving our ability to make statistical inferences about hard-to-observe social and political phenomena, which in turn leads to a more credible evidence based to support policy decisions. 
